        ...
        <div className="space-y-6 py-4">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
            <p className="text-xs text-blue-700 text-center">
              <span className="font-medium">Security Note:</span> This code adds an extra layer of security to your account. 
              Never share it with anyone.
            </p>
          </div>
        </div>

        <DialogFooter className="flex flex-col sm:flex-col space-y-3">
          <Button
