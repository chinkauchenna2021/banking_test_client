        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div>
            ...
            <p className="text-muted-foreground">
              {getAccountStats().total} accounts • ${getAccountStats().totalBalance.toLocaleString()} total balance
            </p>
          </div>
            ...
            {filteredAccounts.length > 0 ? (
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <CardDescription className="text-sm">
                                {account.account_number.slice(0, 4)} **** **** {account.account_number.slice(-4)}
                              </CardDescription>
                            </div>
                          </div>
              ...
              <Card className="text-center py-12">
                <CardContent className="space-y-4">
                  ...
                  <p className="text-muted-foreground">
                    {searchQuery ? 'No accounts match your search' : 'Get started by creating your first account'}
                  </p>
            ...
            <CardContent className="pt-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div className="text-2xl font-bold">{getAccountStats().active}</div>
                </div>
            ...
            <CardContent className="pt-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div className="text-2xl font-bold">{getAccountStats().total}</div>
                </div>
