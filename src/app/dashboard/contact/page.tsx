        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <CardContent className="pt-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div className="text-2xl font-bold">{contactStats.responseTime}h</div>
                </div>
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-muted-foreground">Support Languages</p>
                  <div className="text-2xl font-bold">{contactStats.supportLanguages.length}</div>
                </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-3">
                        ...
                        <Select
                          ...
                          onValueChange={(value) => setMessageData({
                            ...messageData,
                            type: value
                          })}
                        >
                ...
                <CardContent className="space-y-4">
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-muted-foreground">support@bank.com</div>
                      </div>
                    </div>
                  ...
                  <div className="pt-4 border-t">
                    ...
                    <div className="space-y-1">
                      <div className="font-bold text-lg">1-800-911-4567</div>
                      <div className="text-sm">For lost/stolen cards or suspected fraud</div>
                    </div>
                  </div>
                </CardContent>
              </Card>
                  ...
                  <AccordionItem value="account" className="border rounded-lg px-4">
                    <AccordionTrigger className="hover:no-underline">
                      <div className="flex items-start gap-3 text-left">
                        ...
                        <div>
                          <div className="font-semibold">How do I open a new account?</div>
                    ...
                    <AccordionContent className="pt-2 pb-4">
                      <div className="pl-8 text-muted-foreground">
                        You can open a new account through our website or mobile app. 
                        Simply navigate to the Accounts section and click "New Account". 
                        You'll need to provide some basic information and verify your identity.
                      </div>
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="security" className="border rounded-lg px-4">
                    <AccordionTrigger className="hover:no-underline">
                      <div className="flex items-start gap-3 text-left">
                        <HelpCircle className="h-5 w-5 text-blue-600 mt-0.5 flex-shrink-0" />
                        <div>
                          <div className="font-semibold">Is my money safe with your bank?</div>
                          <Badge variant="outline" className="mt-1">
                            Security
                          </Badge>
                        </div>
                    ...
                    <AccordionContent className="pt-2 pb-4">
                      <div className="pl-8 text-muted-foreground">
                        Yes, all deposits are insured up to $250,000 by the FDIC. 
                        We use bank-level encryption and security measures to protect your information.
                      </div>
                    </AccordionContent>
                  </AccordionItem>
                  
                  <AccordionItem value="transactions" className="border rounded-lg px-4">
                    <AccordionTrigger className="hover:no-underline">
                      <div className="flex items-start gap-3 text-left">
                        <HelpCircle className="h-5 w-5 text-blue-600 mt-0.5 flex-shrink-0" />
                        <div>
                          <div className="font-semibold">How long do transfers take?</div>
                          <Badge variant="outline" className="mt-1">
                            Transactions
                          </Badge>
                        </div>
                    ...
                    <AccordionContent className="pt-2 pb-4">
                      <div className="pl-8 text-muted-foreground">
                        Internal transfers are instant. External transfers typically take 1-3 business days. 
          ...
          <TabsContent value="support">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Our availability for different support channels</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-6">
            ...
            <CardContent className="p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Banking forms & documents</p>
                </div>
              </div>
              <Button variant="outline" className="w-full">
                Download
            ...
            <CardContent className="p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Security or technical issues</p>
                </div>
              </div>
              <Button variant="outline" className="w-full">
                Report Now
